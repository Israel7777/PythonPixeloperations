...
def to_countcolorPixel():
    ...
    #list containing the RGB value of color pixel
    count32bitlist = [<rgb value>] #RGB Value of any colour ex: black [0,0,0]
    ...
    while x < img.width:
        ...
        while y < img.height:
            ...
            if list1[0] == color32bitlist[0]:
                if list1[1] == color32bitlist[1]:
                  if list1[2] == color32bitlist[2]:
